...
export class ConnectionValidator {
  ...
  private static generateRequiredTransition(
    ...
    return {
      ...
      pressureLossCoefficient: 0.1, // Default K-factor for transitions
      fittingGeometry: {
        reductionRatio: 1.0 // Will be calculated based on inlet/outlet sizes
      },

      // SMACNA compliance properties
      smacnaCompliant: true,
      smacnaClassification: 'Standard Transition',
      installationNotes: ['Follow SMACNA 2.5:1 slope ratio'],
