...
// Mock implementations since useFeatureFlag hook doesn't exist

const useFeatureFlag = (flag: string, options?: any) => ({
...
=======
  ...
  const {
    ...
    onError: (err: any) => console.error(`FeatureGate error for ${feature}:`, err),

    onPerformanceWarning: (time: number) => console.warn(`FeatureGate slow response for ${feature}: ${time}ms`)
