...
// FlowProperties interface imported from Canvas3DTypes

// CalculationState interface imported from Canvas3DTypes
...
export class SystemTopologyManager {
  ...
  private initializeFlowProperties(element: any): FlowProperties {
    return {
      ...
      velocity: 0,
      pressureDrop: 0,
      frictionRate: 0.1, // Default friction rate
      reynoldsNumber: 50000, // Default Reynolds number for turbulent flow
  ...
  private generateRequiredFitting(fromPoint: ConnectionPoint, toPoint: ConnectionPoint): DuctFitting {
    ...
    return {
      ...
      fittingGeometry: {
        angle: 90, // Default 90-degree fitting
        bendRadius: 12 // Default bend radius in inches
      },
