...
- main "Main content":
  ...
  - toolbar "Drawing tools":
    - group "Drawing tools":
      - text: Tools
      - button "Select tool - Select and move objects":
        - img
        - text: Select V
      - button "Room tool - Draw rooms and spaces" [pressed]:
        - img
        - text: Room R
    ...
    - button "Import Plan":
      - img
      - text: Import Plan
  - text: "Tool: ROOM Grid: ON | Snap: ON Zoom: 100% Rooms: 0 | Segments: 0 | Equipment: 0 Shortcuts: V: Select | R: Room | D: Duct | E: Equipment | H: Pan G: Toggle Grid | S: Toggle Snap | ESC: Clear Selection"
  - button "Front"
  - button "Back"
  - button "Right"
  - button "Left"
  ...
  - button "Import Project":
    - img
    - text: Import Project
  - text: "Last modified: 7/22/2025, 10:00:17 AM Objects: 0 Ready • 0/3 rooms, 0/25 segments Grid: 20px Zoom: 100%"
  - button "1 1 1":
    - img
    - text: 1 1 1
