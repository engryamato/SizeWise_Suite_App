...
=======
  // Load user tier information - removed since tier service is not available in current context
...
=======
  // Handle service errors - removed since servicesError is not available in current context
...
=======
  ...
  const handleThemeToggle = useCallback(() => {
    ...
    toast.success({
      ...
      description: `Switched to ${resolvedTheme === 'dark' ? 'light' : 'dark'} theme`
...
=======
  // Services are now synchronously available - no loading state needed
