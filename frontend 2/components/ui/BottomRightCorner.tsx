...
export const BottomRightCorner: React.FC<BottomRightCornerProps> = ({ className }) => {
  ...
  return (
    <div className={cn("flex flex-col items-end space-y-3", className || "fixed bottom-6 right-6 z-50")}>
