...
// Stub implementation for DialogPrimitive to avoid @radix-ui dependency
const DialogPrimitive = {
  ...
  Content: React.forwardRef<HTMLDivElement, any>(({ className, children, ...props }, ref) => (
    <div ref={ref} className={cn("fixed left-1/2 top-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 bg-white p-6 shadow-lg rounded-lg", className)} {...props}>
      {children}
    </div>
  )),
