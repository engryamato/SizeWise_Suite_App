...
**Note**: For SizeWise Suite-specific Sentry patterns and examples, see `sentry-guidelines.md` which includes HVAC calculation tracing, authentication patterns, and project operation monitoring.
